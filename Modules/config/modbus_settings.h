...
#define MODBUS_SLAVE_INPUT_REGISTERS_COUNT              (0)    // MODBUS default: 9999
#define MODBUS_SLAVE_OUTPUT_HOLDING_REGISTERS_COUNT     (0)    // MODBUS default: 9999
...
#define MODBUS_MASTER_OUTPUT_HOLDING_REGISTERS_COUNT    (4)    // MODBUS default: 9999
